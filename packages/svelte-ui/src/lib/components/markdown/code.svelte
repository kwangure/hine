...
<code
	class="grid grid-cols-[1fr_max-content] whitespace-pre-wrap rounded border border-neutral-600 bg-zinc-800 py-4 pl-3 pr-5 text-sm text-neutral-200 dark:border-neutral-600 dark:bg-zinc-900"
